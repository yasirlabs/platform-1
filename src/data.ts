...
export const COURSES: Course[] = [
  {
    ...
    rating: 4.8,
    category: 'Design',
    image: 'src/public/images/placeholder.svg',
    curriculum: [
...
export const TRAINERS: Trainer[] = [
  { id: 't1', name: 'Alex Rivera', specialty: 'Graphic Design', coursesCount: 5, avatar: 'src/public/images/placeholder.svg' },
  { id: 't2', name: 'Sarah Chen', specialty: 'Web Development', coursesCount: 8, avatar: 'src/public/images/placeholder.svg' },
  { id: 't3', name: 'David Miller', specialty: 'Data Science', coursesCount: 4, avatar: 'src/public/images/placeholder.svg' },
];
